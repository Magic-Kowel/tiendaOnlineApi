...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 28-03-2024 a las 03:31:20
...
('8cb86aee2f09b69827fef839c382abd3', 'ropa', 1);
...
--
-- Estructura de tabla para la tabla `catgeneros`
--

CREATE TABLE `catgeneros` (
  `ecodGenero` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `tNombre` varchar(50) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Volcado de datos para la tabla `catgeneros`
--

INSERT INTO `catgeneros` (`ecodGenero`, `tNombre`) VALUES
('ac87b0f2-de89-478d-bd3b-2c21559b5f7b', 'Femenino'),
('c0385099-77e0-42bd-b4aa-28583b7e5bc6', 'Masculino'),
('e3bc97fb-ce8c-43a0-983d-43e35e2324da', 'Unisex');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `catmateriales`
--

CREATE TABLE `catmateriales` (
  `ecodMaterial` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `tNombre` varchar(50) NOT NULL,
  `ecodEstatus` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Volcado de datos para la tabla `catmateriales`
--

INSERT INTO `catmateriales` (`ecodMaterial`, `tNombre`, `ecodEstatus`) VALUES
('606c27df3025afef15df191f44a12528', 'peluche', '2660376e-dbf8-44c1-b69f-b2554e3e5d4c'),
('ab606c27df3025afef15df191f44a125', 'brush', '2660376e-dbf8-44c1-b69f-b2554e3e5d4c'),
('b606c27df3025afef15df191f44a1252', 'terciopelo', '2660376e-dbf8-44c1-b69f-b2554e3e5d4c');
...
INSERT INTO `catmenu` (`ecodMenu`, `tNombre`, `Icono`, `fhCreacion`, `ecodEdicion`, `fhEdicion`, `ecodEstatus`, `ecodCreacion`) VALUES
('04d20e983b37b22aa656a550641d0829', 'Tallas', NULL, '2024-02-09', NULL, '2024-03-23 08:38:18', '2660376e-dbf8-44c1-b69f-b2554e3e5d4c', '55a40cc846399cb276ab3c91446612d0'),
('20e983b37b22aa656a550641d082943b', 'Producto', NULL, '2024-02-09', NULL, NULL, '2660376e-dbf8-44c1-b69f-b2554e3e5d4c', '55a40cc846399cb276ab3c91446612d0'),
('2ddf2f9617be62a49a1066560c667845', 'materiales', NULL, '2024-02-13', NULL, '2024-02-13 19:21:50', '2660376e-dbf8-44c1-b69f-b2554e3e5d4c', '55a40cc846399cb276ab3c91446612d0'),
('745c6ed38bd80981cb1d020ed09b4bd5', 'categoria', NULL, '2024-03-22', NULL, '2024-03-25 01:20:10', '2660376e-dbf8-44c1-b69f-b2554e3e5d4c', '55a40cc846399cb276ab3c91446612d0'),
('c9d04d20e983b37b22aa656a550641d0', 'Sistema de menu', NULL, '2024-02-09', NULL, NULL, '2660376e-dbf8-44c1-b69f-b2554e3e5d4c', '55a40cc846399cb276ab3c91446612d0'),
('d6d31f09b451d5671225c5d5c4dbcde6', 'Users', 'AccountCircleIcon', '2024-03-17', NULL, NULL, '2660376e-dbf8-44c1-b69f-b2554e3e5d4c', '55a40cc846399cb276ab3c91446612d0'),
('f91219c077271cd2be76723653b838c2', 'Home', NULL, '2024-03-26', NULL, NULL, '2660376e-dbf8-44c1-b69f-b2554e3e5d4c', '55a40cc846399cb276ab3c91446612d0');
...
CREATE TABLE `catpermisos` (
  `ecodPermiso` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `tNombre` varchar(20) DEFAULT NULL,
...
INSERT INTO `catpermisos` (`ecodPermiso`, `tNombre`, `tDescripcion`) VALUES
('4450223a-eca6-11ee-8aae-9829a68561d2', 'size', NULL),
('4455a1cd-eca6-11ee-8aae-9829a68561d2', 'createSize', NULL),
('44568256-eca6-11ee-8aae-9829a68561d2', 'updateSize', NULL),
('44576e82-eca6-11ee-8aae-9829a68561d2', 'deleteSize', NULL),
('44582ffa-eca6-11ee-8aae-9829a68561d2', 'sizeVariation', NULL),
('4458ec8a-eca6-11ee-8aae-9829a68561d2', 'createSizeVariation', NULL),
('4459b04d-eca6-11ee-8aae-9829a68561d2', 'updateSizeVariation', NULL),
('445a98be-eca6-11ee-8aae-9829a68561d2', 'deleteSizeVariation', NULL),
('445b7664-eca6-11ee-8aae-9829a68561d2', 'product', NULL),
('445c6ad5-eca6-11ee-8aae-9829a68561d2', 'createProduct', NULL),
('445d38b8-eca6-11ee-8aae-9829a68561d2', 'updateProduct', NULL),
('445df4f7-eca6-11ee-8aae-9829a68561d2', 'deleteProduct', NULL),
('445ee65f-eca6-11ee-8aae-9829a68561d2', 'material', NULL),
('445fcffa-eca6-11ee-8aae-9829a68561d2', 'createMaterial', NULL),
('446089de-eca6-11ee-8aae-9829a68561d2', 'updateMaterial', NULL),
('4461a0b5-eca6-11ee-8aae-9829a68561d2', 'deleteMaterial', NULL),
('446260d3-eca6-11ee-8aae-9829a68561d2', 'category', NULL),
('4463600f-eca6-11ee-8aae-9829a68561d2', 'createCategory', NULL),
('44641f18-eca6-11ee-8aae-9829a68561d2', 'updateCategory', NULL),
('4464e03b-eca6-11ee-8aae-9829a68561d2', 'deleteCategory', NULL),
('446596c5-eca6-11ee-8aae-9829a68561d2', 'subcategory', NULL),
('4466a524-eca6-11ee-8aae-9829a68561d2', 'createSubcategory', NULL),
('4467803a-eca6-11ee-8aae-9829a68561d2', 'updateSubcategory', NULL),
('44686e2e-eca6-11ee-8aae-9829a68561d2', 'deleteSubcategory', NULL),
('446929f1-eca6-11ee-8aae-9829a68561d2', 'menu', NULL),
('446a04cb-eca6-11ee-8aae-9829a68561d2', 'createMenu', NULL),
('446ab9d4-eca6-11ee-8aae-9829a68561d2', 'updateMenu', NULL),
('446b7fe4-eca6-11ee-8aae-9829a68561d2', 'deleteMenu', NULL),
('446c3496-eca6-11ee-8aae-9829a68561d2', 'submenu', NULL),
('446d24a2-eca6-11ee-8aae-9829a68561d2', 'createSubmenu', NULL),
('446e1d36-eca6-11ee-8aae-9829a68561d2', 'updateSubmenu', NULL),
('446ec0bc-eca6-11ee-8aae-9829a68561d2', 'deleteSubmenu', NULL),
('446f713d-eca6-11ee-8aae-9829a68561d2', 'user', NULL),
('447092dc-eca6-11ee-8aae-9829a68561d2', 'createUser', NULL),
('44713d8d-eca6-11ee-8aae-9829a68561d2', 'updateUser', NULL),
('4471e95b-eca6-11ee-8aae-9829a68561d2', 'deleteUser', NULL),
('4472f575-eca6-11ee-8aae-9829a68561d2', 'typeUser', NULL),
('4473a1cb-eca6-11ee-8aae-9829a68561d2', 'transferPermission', NULL),
('98d2bebb-eca5-11ee-8aae-9829a68561d2', 'size', NULL),
('98d34c1d-eca5-11ee-8aae-9829a68561d2', 'createSize', NULL),
('98d352a5-eca5-11ee-8aae-9829a68561d2', 'updateSize', NULL),
('98d3579c-eca5-11ee-8aae-9829a68561d2', 'deleteSize', NULL),
('98d35c63-eca5-11ee-8aae-9829a68561d2', 'sizeVariation', NULL),
('98d3612a-eca5-11ee-8aae-9829a68561d2', 'createSizeVariation', NULL),
('98d36647-eca5-11ee-8aae-9829a68561d2', 'updateSizeVariation', NULL),
('98d36ba3-eca5-11ee-8aae-9829a68561d2', 'deleteSizeVariation', NULL),
('98d3707c-eca5-11ee-8aae-9829a68561d2', 'product', NULL),
('98d37517-eca5-11ee-8aae-9829a68561d2', 'createProduct', NULL),
('98d379a2-eca5-11ee-8aae-9829a68561d2', 'updateProduct', NULL),
('98d37e20-eca5-11ee-8aae-9829a68561d2', 'deleteProduct', NULL),
('98d38290-eca5-11ee-8aae-9829a68561d2', 'material', NULL),
('98d386fb-eca5-11ee-8aae-9829a68561d2', 'createMaterial', NULL),
('98d38b77-eca5-11ee-8aae-9829a68561d2', 'updateMaterial', NULL),
('98d38ff3-eca5-11ee-8aae-9829a68561d2', 'deleteMaterial', NULL),
('98d3945d-eca5-11ee-8aae-9829a68561d2', 'category', NULL),
('98d398bb-eca5-11ee-8aae-9829a68561d2', 'createCategory', NULL),
('98d39d28-eca5-11ee-8aae-9829a68561d2', 'updateCategory', NULL),
('98d3a190-eca5-11ee-8aae-9829a68561d2', 'deleteCategory', NULL),
('98d3a5ec-eca5-11ee-8aae-9829a68561d2', 'subcategory', NULL),
('98d3aa50-eca5-11ee-8aae-9829a68561d2', 'createSubcategory', NULL),
('98d3aeb5-eca5-11ee-8aae-9829a68561d2', 'updateSubcategory', NULL),
('98d3b326-eca5-11ee-8aae-9829a68561d2', 'deleteSubcategory', NULL),
('98d3b783-eca5-11ee-8aae-9829a68561d2', 'menu', NULL),
('98d3bbe8-eca5-11ee-8aae-9829a68561d2', 'createMenu', NULL),
('98d3c03f-eca5-11ee-8aae-9829a68561d2', 'updateMenu', NULL),
('98d3c4af-eca5-11ee-8aae-9829a68561d2', 'deleteMenu', NULL),
('98d3c921-eca5-11ee-8aae-9829a68561d2', 'submenu', NULL),
('98d3cd86-eca5-11ee-8aae-9829a68561d2', 'createSubmenu', NULL),
('ba426ae7-eca5-11ee-8aae-9829a68561d2', 'size', NULL),
('ba427d97-eca5-11ee-8aae-9829a68561d2', 'createSize', NULL),
('ba428786-eca5-11ee-8aae-9829a68561d2', 'updateSize', NULL),
('ba428d93-eca5-11ee-8aae-9829a68561d2', 'deleteSize', NULL),
('ba429442-eca5-11ee-8aae-9829a68561d2', 'sizeVariation', NULL),
('ba4299b2-eca5-11ee-8aae-9829a68561d2', 'createSizeVariation', NULL),
('ba429f43-eca5-11ee-8aae-9829a68561d2', 'updateSizeVariation', NULL),
('ba42a4f4-eca5-11ee-8aae-9829a68561d2', 'deleteSizeVariation', NULL),
('ba42aa5b-eca5-11ee-8aae-9829a68561d2', 'product', NULL),
('ba42afc9-eca5-11ee-8aae-9829a68561d2', 'createProduct', NULL),
('ba42b517-eca5-11ee-8aae-9829a68561d2', 'updateProduct', NULL),
('ba42bab1-eca5-11ee-8aae-9829a68561d2', 'deleteProduct', NULL),
('ba42c034-eca5-11ee-8aae-9829a68561d2', 'material', NULL),
('ba42c5b9-eca5-11ee-8aae-9829a68561d2', 'createMaterial', NULL),
('ba42c9da-eca5-11ee-8aae-9829a68561d2', 'updateMaterial', NULL),
('ba42d086-eca5-11ee-8aae-9829a68561d2', 'deleteMaterial', NULL),
('ba42d5ac-eca5-11ee-8aae-9829a68561d2', 'category', NULL),
('ba42dab4-eca5-11ee-8aae-9829a68561d2', 'createCategory', NULL),
('ba42df50-eca5-11ee-8aae-9829a68561d2', 'updateCategory', NULL),
('ba42e3c4-eca5-11ee-8aae-9829a68561d2', 'deleteCategory', NULL),
('ba42e853-eca5-11ee-8aae-9829a68561d2', 'subcategory', NULL),
('ba42ecd1-eca5-11ee-8aae-9829a68561d2', 'createSubcategory', NULL),
('ba42f03e-eca5-11ee-8aae-9829a68561d2', 'updateSubcategory', NULL),
('ba42f3aa-eca5-11ee-8aae-9829a68561d2', 'deleteSubcategory', NULL),
('ba42f700-eca5-11ee-8aae-9829a68561d2', 'menu', NULL),
('ba42fa5a-eca5-11ee-8aae-9829a68561d2', 'createMenu', NULL),
('ba42fdab-eca5-11ee-8aae-9829a68561d2', 'updateMenu', NULL),
('ba4300fc-eca5-11ee-8aae-9829a68561d2', 'deleteMenu', NULL),
('ba43044e-eca5-11ee-8aae-9829a68561d2', 'submenu', NULL),
('ba4307a1-eca5-11ee-8aae-9829a68561d2', 'createSubmenu', NULL);
...
CREATE TABLE `catproductos` (
  ...
  `tNombre` varchar(50) NOT NULL,
  `ecodEstatus` varchar(50) NOT NULL,
  `ecodMaterial` varchar(50) NOT NULL,
  `tModelo` varchar(20) DEFAULT NULL,
  `tMarca` varchar(50) DEFAULT NULL,
  `ecodGenero` varchar(50) NOT NULL,
...
INSERT INTO `catproductos` (`ecodProductos`, `tNombre`, `ecodEstatus`, `ecodMaterial`, `tModelo`, `tMarca`, `ecodGenero`, `Descripcion`, `ecodsubcategoria`) VALUES
('1959363aded6d31f09b451d5671225c5', 'prueba9', '2660376e-dbf8-44c1-b69f-b2554e3e5d4c', 'b606c27df3025afef15df191f44a1252', NULL, NULL, 'ac87b0f2-de89-478d-bd3b-2c21559b5f7b', 'prueba9', 'cb86aee2f09b69827fef839c382abd3b'),
('3f38a24f7438b27bb92cf3ae6f9d8763', 'prueba dani', '2660376e-dbf8-44c1-b69f-b2554e3e5d4c', '606c27df3025afef15df191f44a12528', NULL, NULL, 'ac87b0f2-de89-478d-bd3b-2c21559b5f7b', 'prueba dani', 'cb86aee2f09b69827fef839c382abd3b'),
('410fef7f439b3fc9039bd63b14f5edbc', 'prueba2', 'fa6cc9a2-f221-4e27-b575-1fac2698d27a', '606c27df3025afef15df191f44a12528', NULL, NULL, 'ac87b0f2-de89-478d-bd3b-2c21559b5f7b', 'prueba2', 'cb86aee2f09b69827fef839c382abd3b'),
('44ff52a81450dc1ea6e342c40dc60aae', 'w', '2660376e-dbf8-44c1-b69f-b2554e3e5d4c', '606c27df3025afef15df191f44a12528', NULL, NULL, 'ac87b0f2-de89-478d-bd3b-2c21559b5f7b', 'w', 'cb86aee2f09b69827fef839c382abd3b'),
('50a01a692a289fb01543580d88e43f92', 'prueba', 'fa6cc9a2-f221-4e27-b575-1fac2698d27a', '606c27df3025afef15df191f44a12528', NULL, NULL, 'ac87b0f2-de89-478d-bd3b-2c21559b5f7b', 'prueba', 'cb86aee2f09b69827fef839c382abd3b'),
('63aded6d31f09b451d5671225c5d5c4d', 'prueba9', '2660376e-dbf8-44c1-b69f-b2554e3e5d4c', 'b606c27df3025afef15df191f44a1252', NULL, NULL, 'ac87b0f2-de89-478d-bd3b-2c21559b5f7b', 'prueba9', 'cb86aee2f09b69827fef839c382abd3b'),
('680f5238b2e8c33903144b718f067479', 'Pijama de mujer', '2660376e-dbf8-44c1-b69f-b2554e3e5d4c', '606c27df3025afef15df191f44a12528', NULL, NULL, 'ac87b0f2-de89-478d-bd3b-2c21559b5f7b', 'w', 'cb86aee2f09b69827fef839c382abd3b'),
('7f439b3fc9039bd63b14f5edbcc7885e', 'prueba6', 'fa6cc9a2-f221-4e27-b575-1fac2698d27a', '606c27df3025afef15df191f44a12528', NULL, NULL, 'ac87b0f2-de89-478d-bd3b-2c21559b5f7b', 'prueba6', 'cb86aee2f09b69827fef839c382abd3b'),
('f03410fef7f439b3fc9039bd63b14f5e', 'prueba1', '2660376e-dbf8-44c1-b69f-b2554e3e5d4c', '606c27df3025afef15df191f44a12528', NULL, NULL, 'ac87b0f2-de89-478d-bd3b-2c21559b5f7b', 'prueba1', 'cb86aee2f09b69827fef839c382abd3b'),
('fef7f439b3fc9039bd63b14f5edbcc78', 'prueba2', 'fa6cc9a2-f221-4e27-b575-1fac2698d27a', '606c27df3025afef15df191f44a12528', NULL, NULL, 'ac87b0f2-de89-478d-bd3b-2c21559b5f7b', 'prueba2', 'cb86aee2f09b69827fef839c382abd3b');
...
('cb86aee2f09b69827fef839c382abd3b', 'pijama', '8cb86aee2f09b69827fef839c382abd3', 1);
...
CREATE TABLE `catsubmenu` (
  ...
  `tAlias` varchar(20) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `catsubmenu` (`ecodSubmenu`, `tNombre`, `tUrl`, `fhCreacion`, `ecodEstatus`, `ecodEdicion`, `fhEdicion`, `ecodCreacion`, `ecodMenu`, `icon`, `tAlias`) VALUES
('0e983b37b22aa656a550641d082943bc', 'Categorías', 'category', '2024-02-09', '2660376e-dbf8-44c1-b69f-b2554e3e5d4c', NULL, '2024-03-25 01:25:26', '55a40cc846399cb276ab3c91446612d0', '745c6ed38bd80981cb1d020ed09b4bd5', 'fa-solid fa-box', 'category'),
('13aa94115480904be4d961196a01fe38', 'crear usuario', 'user/create', '2024-03-17', '2660376e-dbf8-44c1-b69f-b2554e3e5d4c', NULL, NULL, '55a40cc846399cb276ab3c91446612d0', 'd6d31f09b451d5671225c5d5c4dbcde6', 'fa-solid fa-circle-user', 'userCreate'),
('22cb1198709c38db27b225c8e3a769fb', 'Productos', 'product', '2024-02-15', '2660376e-dbf8-44c1-b69f-b2554e3e5d4c', NULL, NULL, '55a40cc846399cb276ab3c91446612d0', '20e983b37b22aa656a550641d082943b', 'fa-solid fa-box', 'product'),
('2cb1198709c38db27b225c8e3a769fbe', 'crear producto', 'product/create', '2024-02-15', '2660376e-dbf8-44c1-b69f-b2554e3e5d4c', NULL, NULL, '55a40cc846399cb276ab3c91446612d0', '20e983b37b22aa656a550641d082943b', 'fa-solid fa-box', 'productCreat'),
('4d20e983b37b22aa656a550641d08294', 'Tallas', 'size', '2024-02-09', '2660376e-dbf8-44c1-b69f-b2554e3e5d4c', NULL, '2024-03-23 01:57:40', '55a40cc846399cb276ab3c91446612d0', '04d20e983b37b22aa656a550641d0829', 'fa-solid fa-expand', 'size'),
('6d31f09b451d5671225c5d5c4dbcde66', 'user', 'user', '2024-03-17', '2660376e-dbf8-44c1-b69f-b2554e3e5d4c', NULL, NULL, '55a40cc846399cb276ab3c91446612d0', 'd6d31f09b451d5671225c5d5c4dbcde6', 'fa-solid fa-circle-user', 'user'),
('91219c077271cd2be76723653b838c20', 'Home', 'home/', '2024-03-26', '2660376e-dbf8-44c1-b69f-b2554e3e5d4c', NULL, '2024-03-26 13:19:52', '55a40cc846399cb276ab3c91446612d0', 'f91219c077271cd2be76723653b838c2', 'fa-solid fa-house', 'home'),
('9890f9e71dddf36ea58f8481efc784f3', 'Crear categoria', 'category/create', '2024-03-24', '2660376e-dbf8-44c1-b69f-b2554e3e5d4c', NULL, '2024-03-25 01:25:47', '55a40cc846399cb276ab3c91446612d0', '745c6ed38bd80981cb1d020ed09b4bd5', 'fa-solid fa-box', 'categoryCreate'),
('9d04d20e983b37b22aa656a550641d08', 'menu', 'security/menu', '2024-02-09', '2660376e-dbf8-44c1-b69f-b2554e3e5d4c', NULL, NULL, '55a40cc846399cb276ab3c91446612d0', 'c9d04d20e983b37b22aa656a550641d0', 'fa-solid fa-gear', 'securityMenu'),
('c1f394346e253ae4691d115540a62fb6', 'Tipo de usuario', 'security/permissions', '2024-03-23', '2660376e-dbf8-44c1-b69f-b2554e3e5d4c', NULL, '2024-03-23 08:41:11', '55a40cc846399cb276ab3c91446612d0', 'd6d31f09b451d5671225c5d5c4dbcde6', 'fa-solid fa-circle-user', 'securityPermission'),
('d04d20e983b37b22aa656a550641d082', 'sub menu', 'security/submenu', '2024-02-09', '2660376e-dbf8-44c1-b69f-b2554e3e5d4c', NULL, NULL, '55a40cc846399cb276ab3c91446612d0', 'c9d04d20e983b37b22aa656a550641d0', 'fa-solid fa-gear', 'securitySubmenu'),
('d20e983b37b22aa656a550641d082943', 'Rangos de Tallas', 'size/variation', '2024-02-09', '2660376e-dbf8-44c1-b69f-b2554e3e5d4c', NULL, '2024-03-23 01:57:51', '55a40cc846399cb276ab3c91446612d0', '04d20e983b37b22aa656a550641d0829', 'fa-solid fa-expand', 'sizeVariation'),
('ddf2f9617be62a49a1066560c6678455', 'material', 'material', '2024-02-13', '2660376e-dbf8-44c1-b69f-b2554e3e5d4c', NULL, '2024-03-23 01:52:42', '55a40cc846399cb276ab3c91446612d0', '2ddf2f9617be62a49a1066560c667845', 'fa-solid fa-scissors', 'material');
...
('2', 'cliente', 'cliente que compra'),
('3', 'ayudante', 'chica que ayuda');
...
('a035ce134a053ba6e832ce3d9ca74177', 'josu', 'morfin', 'josue.ingeniero.ti@gmail.com', '$2a$10$3gJl6bmvUJ0jUBbBvo9HLOEsfg6m.2mzmGS0n8mY.jj2wQIXoC7Nm', NULL, '2024-03-18 11:57:11', '3', '2660376e-dbf8-44c1-b69f-b2554e3e5d4c', NULL, NULL, NULL, NULL, NULL, NULL, '2024-03-04');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `grupoetario`
--

CREATE TABLE `grupoetario` (
  `ecodGrupoetario` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `tNombre` varchar(30) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Volcado de datos para la tabla `grupoetario`
--

INSERT INTO `grupoetario` (`ecodGrupoetario`, `tNombre`) VALUES
('480816cc-1cbd-4714-8697-c218dc875070', 'Adulto'),
('9a4a20bb-85f3-4432-b171-8d0352e668f4', 'Infantil');
...
CREATE TABLE `relproductoimagen` (
  ...
  `ecodProductos` varchar(50) NOT NULL,
  `tipoAlmacenamiento` enum('url','servicio') NOT NULL,
  `publicId` varchar(50) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Volcado de datos para la tabla `relproductoimagen`
--

INSERT INTO `relproductoimagen` (`ecodRelProductoImagen`, `iImagen`, `ecodProductos`, `tipoAlmacenamiento`, `publicId`) VALUES
('0fef7f439b3fc9039bd63b14f5edbcc7', 'https://scontent.fgdl2-2.fna.fbcdn.net/v/t39.30808-6/427872709_1602898177135351_7774006982407282485_n.jpg?_nc_cat=104&ccb=1-7&_nc_sid=5f2048&_nc_eui2=AeGRN8g7dCWAU-B8q9WGXfW2gJEtMs8p5VWAkS0yzynlVf0IlEuAHRQgUnUFgBxc0eNmQpRcdLn26K081Ncak7QY&_nc_ohc=DIJ', '410fef7f439b3fc9039bd63b14f5edbc', 'url', NULL),
('136793ecf3aaf05fa7c8b96eb361b75a', 'http://res.cloudinary.com/ddyldtxfs/image/upload/v1710119914/magicImages/ok7wrjgavprt4kbbxsot.jpg', 'faa573543c8136793ecf3aaf05fa7c8b', 'servicio', 'magicImages/ok7wrjgavprt4kbbxsot'),
('14f0c4bbc00a41d17966d696d7d923b9', 'http://res.cloudinary.com/ddyldtxfs/image/upload/v1710105058/magicImages/tp2pqrf6e5x5zlzvlclb.jpg', 'cb14f0c4bbc00a41d17966d696d7d923', 'servicio', 'magicImages/tp2pqrf6e5x5zlzvlclb'),
('363aded6d31f09b451d5671225c5d5c4', 'http://res.cloudinary.com/ddyldtxfs/image/upload/v1710683053/magicImages/mow4pfesc9hvljzdqyhr.jpg', '1959363aded6d31f09b451d5671225c5', 'servicio', 'magicImages/mow4pfesc9hvljzdqyhr'),
('36793ecf3aaf05fa7c8b96eb361b75a5', 'http://res.cloudinary.com/ddyldtxfs/image/upload/v1710119916/magicImages/tuny6j6qqbjsr0jjzbx6.jpg', 'faa573543c8136793ecf3aaf05fa7c8b', 'servicio', 'magicImages/tuny6j6qqbjsr0jjzbx6'),
('38e254272b13392f31e6cb876433cf7c', 'http://res.cloudinary.com/ddyldtxfs/image/upload/v1711212130/magicImages/oovmt1jd3fwxazq9glj7.png', 'f03410fef7f439b3fc9039bd63b14f5e', 'servicio', 'magicImages/oovmt1jd3fwxazq9glj7'),
('3ecf3aaf05fa7c8b96eb361b75a55dc4', 'http://res.cloudinary.com/ddyldtxfs/image/upload/v1710120041/magicImages/vnt1px9rkertnybigazv.jpg', '6793ecf3aaf05fa7c8b96eb361b75a55', 'servicio', 'magicImages/vnt1px9rkertnybigazv'),
('439b3fc9039bd63b14f5edbcc7885efe', 'https://scontent.fgdl2-1.fna.fbcdn.net/v/t39.30808-6/427838659_1602898383801997_3669813319481256769_n.jpg?_nc_cat=108&ccb=1-7&_nc_sid=5f2048&_nc_eui2=AeFlJuN3toDcbuiPMQQGS11-oY6-qUL-i7yhjr6pQv6LvJHvCaCf-PtcTguGYZfiSheVNSGMhFSPIytyBaHA_D55&_nc_ohc=E1q', '7f439b3fc9039bd63b14f5edbcc7885e', 'url', NULL),
('480a07cd045788c78699c8a13a39822d', 'http://res.cloudinary.com/ddyldtxfs/image/upload/v1710119102/magicImages/erww0mcvybln2p0ziytb.jpg', '74358b16480a07cd045788c78699c8a1', 'servicio', 'magicImages/erww0mcvybln2p0ziytb'),
('4cfaa573543c8136793ecf3aaf05fa7c', 'http://res.cloudinary.com/ddyldtxfs/image/upload/v1710119842/magicImages/jwj6w84sbjhlwebmia0o.jpg', '4d7eb4cfaa573543c8136793ecf3aaf0', 'servicio', 'magicImages/jwj6w84sbjhlwebmia0o'),
('4f7438b27bb92cf3ae6f9d8763e76776', 'http://res.cloudinary.com/ddyldtxfs/image/upload/v1711319594/magicImages/kyyrzbkc0xiipr3q9ntn.jpg', '3f38a24f7438b27bb92cf3ae6f9d8763', 'servicio', 'magicImages/kyyrzbkc0xiipr3q9ntn'),
('52a81450dc1ea6e342c40dc60aae5c16', 'http://res.cloudinary.com/ddyldtxfs/image/upload/v1710137444/magicImages/a7vh95wyvocqr6hhoiwj.jpg', '44ff52a81450dc1ea6e342c40dc60aae', 'servicio', 'magicImages/a7vh95wyvocqr6hhoiwj'),
('54d7eb4cfaa573543c8136793ecf3aaf', 'http://res.cloudinary.com/ddyldtxfs/image/upload/v1710119833/magicImages/viq1qeyu2mkrd4gethh9.jpg', '831dfa54d7eb4cfaa573543c8136793e', 'servicio', 'magicImages/viq1qeyu2mkrd4gethh9'),
('8a24f7438b27bb92cf3ae6f9d8763e76', 'http://res.cloudinary.com/ddyldtxfs/image/upload/v1711319291/magicImages/uagzo9pwnp2ojc9p5ch0.jpg', '3f38a24f7438b27bb92cf3ae6f9d8763', 'servicio', 'magicImages/uagzo9pwnp2ojc9p5ch0'),
('a01a692a289fb01543580d88e43f92ed', 'https://scontent.fgdl2-1.fna.fbcdn.net/v/t39.30808-6/427838659_1602898383801997_3669813319481256769_n.jpg?_nc_cat=108&ccb=1-7&_nc_sid=5f2048&_nc_eui2=AeFlJuN3toDcbuiPMQQGS11-oY6-qUL-i7yhjr6pQv6LvJHvCaCf-PtcTguGYZfiSheVNSGMhFSPIytyBaHA_D55&_nc_ohc=E1q', '50a01a692a289fb01543580d88e43f92', 'url', NULL),
('a24f7438b27bb92cf3ae6f9d8763e767', 'http://res.cloudinary.com/ddyldtxfs/image/upload/v1711319292/magicImages/gbompqoub6udnen8pzze.jpg', '3f38a24f7438b27bb92cf3ae6f9d8763', 'servicio', 'magicImages/gbompqoub6udnen8pzze'),
('a54d7eb4cfaa573543c8136793ecf3aa', 'http://res.cloudinary.com/ddyldtxfs/image/upload/v1710119832/magicImages/fqamdibm5pidfh6mvwnl.jpg', '831dfa54d7eb4cfaa573543c8136793e', 'servicio', 'magicImages/fqamdibm5pidfh6mvwnl'),
('b38e254272b13392f31e6cb876433cf7', 'http://res.cloudinary.com/ddyldtxfs/image/upload/v1711212129/magicImages/tvacwmsbexrtk4kd3t7r.jpg', 'f03410fef7f439b3fc9039bd63b14f5e', 'servicio', 'magicImages/tvacwmsbexrtk4kd3t7r'),
('b94b4aa770c5ce0d2bdf08f5c7c82115', 'http://res.cloudinary.com/ddyldtxfs/image/upload/v1710139026/magicImages/bxjqy7rzwpep9tuastae.jpg', '44ff52a81450dc1ea6e342c40dc60aae', 'servicio', 'magicImages/bxjqy7rzwpep9tuastae'),
('bbc00a41d17966d696d7d923b95e9ced', 'http://res.cloudinary.com/ddyldtxfs/image/upload/v1710118256/magicImages/sgjdoh0iruox7yt18trr.jpg', '4f0c4bbc00a41d17966d696d7d923b95', 'servicio', 'magicImages/sgjdoh0iruox7yt18trr'),
('cb38e254272b13392f31e6cb876433cf', 'http://res.cloudinary.com/ddyldtxfs/image/upload/v1711212128/magicImages/rvmfpfxseexw2crztk2s.jpg', 'f03410fef7f439b3fc9039bd63b14f5e', 'servicio', 'magicImages/rvmfpfxseexw2crztk2s'),
('cfaa573543c8136793ecf3aaf05fa7c8', 'http://res.cloudinary.com/ddyldtxfs/image/upload/v1710119843/magicImages/jwiwlrvaathw2ya9v9x6.jpg', '4d7eb4cfaa573543c8136793ecf3aaf0', 'servicio', 'magicImages/jwiwlrvaathw2ya9v9x6'),
('d680f5238b2e8c33903144b718f06747', 'http://res.cloudinary.com/ddyldtxfs/image/upload/v1710121485/magicImages/vxjwnheladmuqfmpq1t3.jpg', '722bd680f5238b2e8c33903144b718f0', 'servicio', 'magicImages/vxjwnheladmuqfmpq1t3'),
('d722bd680f5238b2e8c33903144b718f', 'http://res.cloudinary.com/ddyldtxfs/image/upload/v1710121374/magicImages/dvfajoabpcqjx1lujjxt.jpg', 'c40cd722bd680f5238b2e8c33903144b', 'servicio', 'magicImages/dvfajoabpcqjx1lujjxt'),
('ed6d31f09b451d5671225c5d5c4dbcde', 'http://res.cloudinary.com/ddyldtxfs/image/upload/v1710683099/magicImages/cjotridkvtynobkp7g5h.jpg', '63aded6d31f09b451d5671225c5d5c4d', 'servicio', 'magicImages/cjotridkvtynobkp7g5h'),
('f58d1a4100e9d0277596f010b8a9395d', 'http://res.cloudinary.com/ddyldtxfs/image/upload/v1710120303/magicImages/xfqss2ymcqvwgcgydzzh.jpg', 'cb28f58d1a4100e9d0277596f010b8a9', 'servicio', 'magicImages/xfqss2ymcqvwgcgydzzh'),
('f7f439b3fc9039bd63b14f5edbcc7885', 'https://scontent.fgdl2-1.fna.fbcdn.net/v/t39.30808-6/427818107_1602898357135333_4954861281444856532_n.jpg?_nc_cat=111&ccb=1-7&_nc_sid=5f2048&_nc_eui2=AeHQNJAjDo6HpwzMshxN7uw6Sdv3sgEuaS5J2_eyAS5pLueCYVTswMf9tWhtnBsg_yn4uPNRTffTnufv-eKLPEWS&_nc_ohc=hy0', 'fef7f439b3fc9039bd63b14f5edbcc78', 'url', NULL);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `reltipousuariopermisos`
--

CREATE TABLE `reltipousuariopermisos` (
  `ecodRelTipoUsuarioPermiso` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `ecodPermiso` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `ecodTipoUsuario` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `ecodSubmenu` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Volcado de datos para la tabla `reltipousuariopermisos`
--

INSERT INTO `reltipousuariopermisos` (`ecodRelTipoUsuarioPermiso`, `ecodPermiso`, `ecodTipoUsuario`, `ecodSubmenu`) VALUES
('5d14feace896a9eaf7ff7093260aef02', '445ee65f-eca6-11ee-8aae-9829a68561d2', '1', 'ddf2f9617be62a49a1066560c6678455'),
('c61ddc0e-ecaa-11ee-8aae-9829a68561d2', '445fcffa-eca6-11ee-8aae-9829a68561d2', '1', 'ddf2f9617be62a49a1066560c6678455');
...
('03410fef7f439b3fc9039bd63b14f5ed', '0d5daecdcd32f4c9688e1985cd84628d', 'f03410fef7f439b3fc9039bd63b14f5e', 22.00, 1, 1, '2660376e-dbf8-44c1-b69f-b2554e3e5d4c'),
...
('0a01a692a289fb01543580d88e43f92e', '0d5daecdcd32f4c9688e1985cd84628d', '50a01a692a289fb01543580d88e43f92', 2.00, 2, 1, '2660376e-dbf8-44c1-b69f-b2554e3e5d4c'),
...
('10fef7f439b3fc9039bd63b14f5edbcc', '0d5daecdcd32f4c9688e1985cd84628d', '410fef7f439b3fc9039bd63b14f5edbc', 22.00, 1, 1, '2660376e-dbf8-44c1-b69f-b2554e3e5d4c'),
('14f03410fef7f439b3fc9039bd63b14f', 'cf158c79626d9ba383260a736ec44a58', '44ff52a81450dc1ea6e342c40dc60aae', 6.00, 66, 0, '2660376e-dbf8-44c1-b69f-b2554e3e5d4c'),
('38a24f7438b27bb92cf3ae6f9d8763e7', '60d5daecdcd32f4c9688e1985cd84628', '3f38a24f7438b27bb92cf3ae6f9d8763', 5.00, 88, 0, '2660376e-dbf8-44c1-b69f-b2554e3e5d4c'),
('3aded6d31f09b451d5671225c5d5c4db', 'cf158c79626d9ba383260a736ec44a58', '63aded6d31f09b451d5671225c5d5c4d', 44.00, 44, 0, '2660376e-dbf8-44c1-b69f-b2554e3e5d4c'),
...
('59363aded6d31f09b451d5671225c5d5', '0d5daecdcd32f4c9688e1985cd84628d', '1959363aded6d31f09b451d5671225c5', 44.00, 44, NULL, '2660376e-dbf8-44c1-b69f-b2554e3e5d4c'),
...
('9363aded6d31f09b451d5671225c5d5c', 'f60d5daecdcd32f4c9688e1985cd8462', '1959363aded6d31f09b451d5671225c5', 77.00, 77, NULL, '2660376e-dbf8-44c1-b69f-b2554e3e5d4c'),
('959363aded6d31f09b451d5671225c5d', 'cf158c79626d9ba383260a736ec44a58', '1959363aded6d31f09b451d5671225c5', 44.00, 44, 1, '2660376e-dbf8-44c1-b69f-b2554e3e5d4c'),
('a006d83e74d4ea5cd4310e33948b7788', '0d5daecdcd32f4c9688e1985cd84628d', '44ff52a81450dc1ea6e342c40dc60aae', 77.00, 75, 1, '2660376e-dbf8-44c1-b69f-b2554e3e5d4c'),
('aded6d31f09b451d5671225c5d5c4dbc', '0d5daecdcd32f4c9688e1985cd84628d', '63aded6d31f09b451d5671225c5d5c4d', 44.00, 44, 1, '2660376e-dbf8-44c1-b69f-b2554e3e5d4c'),
...
('ded6d31f09b451d5671225c5d5c4dbcd', 'f60d5daecdcd32f4c9688e1985cd8462', '63aded6d31f09b451d5671225c5d5c4d', 77.00, 77, 0, '2660376e-dbf8-44c1-b69f-b2554e3e5d4c'),
('ef7f439b3fc9039bd63b14f5edbcc788', '0d5daecdcd32f4c9688e1985cd84628d', 'fef7f439b3fc9039bd63b14f5edbcc78', 22.00, 1, 1, '2660376e-dbf8-44c1-b69f-b2554e3e5d4c'),
('f38a24f7438b27bb92cf3ae6f9d8763e', '0d5daecdcd32f4c9688e1985cd84628d', '3f38a24f7438b27bb92cf3ae6f9d8763', 2.00, 2, 1, '2660376e-dbf8-44c1-b69f-b2554e3e5d4c'),
('f439b3fc9039bd63b14f5edbcc7885ef', '0d5daecdcd32f4c9688e1985cd84628d', '7f439b3fc9039bd63b14f5edbcc7885e', 22.00, 1, 1, '2660376e-dbf8-44c1-b69f-b2554e3e5d4c'),
...
CREATE TABLE `talla` (
  `ecodTalla` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
...
INSERT INTO `talla` (`ecodTalla`, `tTalla`, `ecodEstatus`) VALUES
('2ea8fcb27d1722a9840c13a50a90fc64', 'prueba', '2660376e-dbf8-44c1-b69f-b2554e3e5d4c'),
('301281aa1db8d6b74d15af6547e9ec78', 'fg', '2660376e-dbf8-44c1-b69f-b2554e3e5d4c'),
('3ab28c3ca9536dc8135c61d3bcf65fd6', 'xl', '2660376e-dbf8-44c1-b69f-b2554e3e5d4c'),
('ac2ea8fcb27d1722a9840c13a50a90fc', 'mediana', '2660376e-dbf8-44c1-b69f-b2554e3e5d4c'),
('c2ea8fcb27d1722a9840c13a50a90fc6', 'grande', '2660376e-dbf8-44c1-b69f-b2554e3e5d4c'),
('cac2ea8fcb27d1722a9840c13a50a90f', 'chica', '2660376e-dbf8-44c1-b69f-b2554e3e5d4c'),
('df3a04bb07bb159be413c4273a00130c', 'unitalla', '2660376e-dbf8-44c1-b69f-b2554e3e5d4c');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `tallavariacion`
--

CREATE TABLE `tallavariacion` (
  `ecodTallavariacion` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `ecodTalla` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `ecodGrupoetario` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `nEdadMinima` int(11) DEFAULT NULL,
  `nEdadMaxima` int(11) DEFAULT NULL,
  `ecodEstatus` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `nTalla` int(2) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Volcado de datos para la tabla `tallavariacion`
--

INSERT INTO `tallavariacion` (`ecodTallavariacion`, `ecodTalla`, `ecodGrupoetario`, `nEdadMinima`, `nEdadMaxima`, `ecodEstatus`, `nTalla`) VALUES
('0d5daecdcd32f4c9688e1985cd84628d', 'cac2ea8fcb27d1722a9840c13a50a90f', '480816cc-1cbd-4714-8697-c218dc875070', 0, 0, '2660376e-dbf8-44c1-b69f-b2554e3e5d4c', 5),
('1cf158c79626d9ba383260a736ec44a5', 'cac2ea8fcb27d1722a9840c13a50a90f', '9a4a20bb-85f3-4432-b171-8d0352e668f4', 1, 2, '2660376e-dbf8-44c1-b69f-b2554e3e5d4c', NULL),
('60d5daecdcd32f4c9688e1985cd84628', 'c2ea8fcb27d1722a9840c13a50a90fc6', '9a4a20bb-85f3-4432-b171-8d0352e668f4', 4, 5, '2660376e-dbf8-44c1-b69f-b2554e3e5d4c', NULL),
('9f60d5daecdcd32f4c9688e1985cd846', 'ac2ea8fcb27d1722a9840c13a50a90fc', '9a4a20bb-85f3-4432-b171-8d0352e668f4', 3, 7, '2660376e-dbf8-44c1-b69f-b2554e3e5d4c', NULL),
('cf158c79626d9ba383260a736ec44a58', 'c2ea8fcb27d1722a9840c13a50a90fc6', '480816cc-1cbd-4714-8697-c218dc875070', 0, 0, '2660376e-dbf8-44c1-b69f-b2554e3e5d4c', 9),
('f60d5daecdcd32f4c9688e1985cd8462', '2ea8fcb27d1722a9840c13a50a90fc64', '480816cc-1cbd-4714-8697-c218dc875070', 0, 0, '2660376e-dbf8-44c1-b69f-b2554e3e5d4c', 22);
...
--
-- Indices de la tabla `catgeneros`
--
ALTER TABLE `catgeneros`
  ADD PRIMARY KEY (`ecodGenero`);

--
-- Indices de la tabla `catmateriales`
--
ALTER TABLE `catmateriales`
  ADD PRIMARY KEY (`ecodMaterial`),
...
ALTER TABLE `catproductos`
  ...
  ADD KEY `ecodEstatus` (`ecodEstatus`),
  ADD KEY `ecodGenero` (`ecodGenero`),
  ADD KEY `ecodMaterial` (`ecodMaterial`),
...
--
-- Indices de la tabla `grupoetario`
--
ALTER TABLE `grupoetario`
  ADD PRIMARY KEY (`ecodGrupoetario`);
...
--
-- Indices de la tabla `reltipousuariopermisos`
--
ALTER TABLE `reltipousuariopermisos`
  ADD PRIMARY KEY (`ecodRelTipoUsuarioPermiso`),
  ADD KEY `ecodPermiso` (`ecodPermiso`),
...
--
ALTER TABLE `talla`
  ADD PRIMARY KEY (`ecodTalla`),
  ADD KEY `talla_catestatus_ecodEstatus_fk` (`ecodEstatus`);

--
-- Indices de la tabla `tallavariacion`
--
ALTER TABLE `tallavariacion`
  ADD PRIMARY KEY (`ecodTallavariacion`),
  ADD KEY `ecodEstatus` (`ecodEstatus`),
  ADD KEY `ecodTalla` (`ecodTalla`),
  ADD KEY `ecodGrupoetario` (`ecodGrupoetario`);
...
--
-- Filtros para la tabla `catmateriales`
--
ALTER TABLE `catmateriales`
  ADD CONSTRAINT `catmateriales_ibfk_1` FOREIGN KEY (`ecodEstatus`) REFERENCES `catestatus` (`ecodEstatus`);
...
ALTER TABLE `catproductos`
  ...
  ADD CONSTRAINT `catproductos_ibfk_5` FOREIGN KEY (`ecodGenero`) REFERENCES `catgeneros` (`ecodGenero`),
  ADD CONSTRAINT `catproductos_ibfk_6` FOREIGN KEY (`ecodMaterial`) REFERENCES `catmateriales` (`ecodMaterial`),
  ADD CONSTRAINT `catproductos_ibfk_7` FOREIGN KEY (`ecodsubcategoria`) REFERENCES `catsubcategoria` (`ecodsubcategoria`);
...
ALTER TABLE `catsubmenu`
  ...
  ADD CONSTRAINT `catsubmenu_ibfk_3` FOREIGN KEY (`ecodMenu`) REFERENCES `catmenu` (`ecodMenu`);
...
--
-- Filtros para la tabla `reltipousuariopermisos`
--
ALTER TABLE `reltipousuariopermisos`
  ADD CONSTRAINT `reltipousuariopermisos_ibfk_1` FOREIGN KEY (`ecodPermiso`) REFERENCES `catpermisos` (`ecodPermiso`),
  ADD CONSTRAINT `reltipousuariopermisos_ibfk_2` FOREIGN KEY (`ecodTipoUsuario`) REFERENCES `cattipousuario` (`ecodTipoUsuario`),
  ADD CONSTRAINT `reltipousuariopermisos_ibfk_3` FOREIGN KEY (`ecodSubmenu`) REFERENCES `catsubmenu` (`ecodSubmenu`);
...
--
ALTER TABLE `talla`
  ADD CONSTRAINT `talla_catestatus_ecodEstatus_fk` FOREIGN KEY (`ecodEstatus`) REFERENCES `catestatus` (`ecodEstatus`);

--
-- Filtros para la tabla `tallavariacion`
--
ALTER TABLE `tallavariacion`
  ADD CONSTRAINT `tallavariacion_ibfk_1` FOREIGN KEY (`ecodEstatus`) REFERENCES `catestatus` (`ecodEstatus`),
  ADD CONSTRAINT `tallavariacion_ibfk_2` FOREIGN KEY (`ecodTalla`) REFERENCES `talla` (`ecodTalla`),
  ADD CONSTRAINT `tallavariacion_ibfk_3` FOREIGN KEY (`ecodGrupoetario`) REFERENCES `grupoetario` (`ecodGrupoetario`);
COMMIT;
