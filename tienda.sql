...
--
-- Estructura de tabla para la tabla `logcatusuario`
--

CREATE TABLE `logcatusuario` (
  `ecodUsuario` varchar(50) NOT NULL,
  `tNombre` varchar(30) NOT NULL,
  `tApellido` varchar(30) NOT NULL,
  `tCorreo` varchar(30) NOT NULL,
  ...
  `ecodEdicion` varchar(50) NOT NULL,
  `fhEdicion` datetime NOT NULL,
  `ecodEliminacion` varchar(50) NOT NULL,
  `fhEliminacion` datetime NOT NULL,
  `tMotivoEliminacion` varchar(250) NOT NULL,
  `fhNacimiento` date NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
